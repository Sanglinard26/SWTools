			...
			for (int i = 0; i < nbLabel; i++) {
				...
				case PaCo.ASCII:
					listLabel.add(new Scalaire(
							label.getElementsByTagName("SHORT-NAME").item(0).getTextContent(), 
							label.getElementsByTagName("LONG-NAME").item(0).getTextContent(), 
							label.getElementsByTagName("CATEGORY").item(0).getTextContent(), 
							swFeatureRef, 
							swUnitRef, 
							readEntry(swCsEntry), 
