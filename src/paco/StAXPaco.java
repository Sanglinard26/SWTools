				...
				if (event.isStartElement()) {
					...
					case SW_INSTANCE:
						...
						case CURVE_FIXED:
							...
							break;
						case CURVE_GROUPED:
							this.listLabel.add(new Curve(shortName.toString(), longName.toString(), category, swFeatureRef, unite, history, valeur, tmpSharedAxis.toArray(new String[tmpSharedAxis.size()])));
						...
						case MAP_FIXED:
							...
							break;
						case MAP_GROUPED:
							this.listLabel.add(new Map(shortName.toString(), longName.toString(), category, swFeatureRef, unite, history, valeur, tmpSharedAxis.toArray(new String[tmpSharedAxis.size()])));
