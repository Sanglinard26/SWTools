        ...
        btOpen = new JButton(new AbstractAction("Ouvrir") {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (reponse == JFileChooser.APPROVE_OPTION) {
                    File dtd = new File(jFileChooser.getSelectedFile().getParent() + "/msrsw_v222_lai_iai_normalized.xml.dtd");
                    if (!dtd.exists()) {
                        InputStream myDtd = getClass().getResourceAsStream("/msrsw_v222_lai_iai_normalized.xml.dtd");

                        try {
                            OutputStream out = new FileOutputStream(
                                    jFileChooser.getSelectedFile().getParent() + "/msrsw_v222_lai_iai_normalized.xml.dtd");
