...
public final class Ihm extends JFrame {
    ...
    public Ihm() {
        ...
        JMenuItem menuItem = new JMenuItem(new AbstractAction(bundle.getString("impCdf")) {

            private static final long serialVersionUID = 1L;

            @Override
            public void actionPerformed(ActionEvent e) {
                final String pathFolder = Utilitaire.getFolder(bundle.getString("titleDialogPath"),
                        Preference.getPreference(Preference.KEY_OPEN_CDF));
        ...
        menuItem = new JMenuItem(new AbstractAction(bundle.getString("impLab")) {

            private static final long serialVersionUID = 1L;

            @Override
            public void actionPerformed(ActionEvent e) {
                final String pathFolder = Utilitaire.getFolder(bundle.getString("titleDialogPath"), Preference.getPreference(Preference.KEY_ADD_LAB));
        ...
        menuItem = new JMenuItem(new AbstractAction(bundle.getString("expLabCompar")) {
        ...
        onglets.addTab(bundle.getString("cdfFiles"), new ImageIcon(getClass().getResource(ICON_FDONNEE)), ongletPaCo);

        // Onglet comparaison de Lab
        onglets.addTab(bundle.getString("labFiles"), new ImageIcon(getClass().getResource(ICON_FVARIABLE)), ongletLab);
