 ...
 * drawn upon a white veil which alpha level (or shield value) lets the underlying component shine through. This panel is meant to be used asa
 * <i>glass pane</i> in the window performing the long operation. <br />
 * <br />
 * On the contrary to regular glass panes, you don't need to set it visible or not by yourself. Once you've started the animation all the mouse events
 * are intercepted by this panel, preventing them from being forwared to the underlying components. <br />
 * <br />
 * The panel can be controlled by the <code>start()</code>, <code>stop()</code> and <code>interrupt()</code> methods. <br />
 * <br />
 * Example: <br />
 * <br />
 * 
...
public class InfiniteProgressPanel extends JComponent implements MouseListener {
     ...
     * @param text The message to be displayed. Can be null or empty.
     * @param barsCount The amount of bars composing the circular shape.
     * @param shield The alpha level between 0.0 and 1.0 of the colored shield (or veil).
     */
     ...
     * @param barsCount The amount of bars composing the circular shape.
     * @param shield The alpha level between 0.0 and 1.0 of the colored shield (or veil).
     * @param fps The number of frames per second. Lower this value to decrease CPU usage.
     */
     ...
     * @param shield The alpha level between 0.0 and 1.0 of the colored shield (or veil).
     * @param fps The number of frames per second. Lower this value to decrease CPU usage.
     * @param rampDelay The duration, in milli seconds, of the fade in and the fade out of the veil.
     */
    ...
    /**
     * Stops the waiting animation by stopping the rotation of the circular shape and then by fading out the veil. This methods sets the panel
